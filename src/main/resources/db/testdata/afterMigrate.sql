...
lock tables cidade write, cozinha write, estado write, forma_pagamento write, grupo write, grupo_permissao write, permissao write,
	 produto write, restaurante write, restaurante_forma_pagamento write,restaurante_usuario_responsavel write, usuario write, usuario_grupo write,
...
insert into estado (id, nome) values (4, 'Pará');
...
insert into cidade (id, nome, estado_id) values (6, 'Benevides', 4);
...
(1, 'João da Silva', 'joao.ger@algafood.com', '$2a$12$rSwRW3j.kV6IBWWNKJvp4O2sD/9cTQjrMdklGoUhifiYhXkT43VHm', utc_timestamp),
(2, 'Maria Joaquina', 'maria.vnd@algafood.com', '$2a$12$rSwRW3j.kV6IBWWNKJvp4O2sD/9cTQjrMdklGoUhifiYhXkT43VHm', utc_timestamp),
(3, 'José Souza', 'jose.aux@algafood.com', '$2a$12$rSwRW3j.kV6IBWWNKJvp4O2sD/9cTQjrMdklGoUhifiYhXkT43VHm', utc_timestamp),
(4, 'Sebastião Martins', 'sebastiao.cad@algafood.com', '$2a$12$rSwRW3j.kV6IBWWNKJvp4O2sD/9cTQjrMdklGoUhifiYhXkT43VHm', utc_timestamp),
(5, 'Manoel Lima', 'manoel.loja@gmail.com', '$2a$12$rSwRW3j.kV6IBWWNKJvp4O2sD/9cTQjrMdklGoUhifiYhXkT43VHm', utc_timestamp),
(6, 'Débora Mendonça', 'jorge.rufino1986@gmail.com', '$2a$12$rSwRW3j.kV6IBWWNKJvp4O2sD/9cTQjrMdklGoUhifiYhXkT43VHm', utc_timestamp),
(7, 'Carlos Lima', 'jorge.rufino1986+carlos@gmail.com', '$2a$12$rSwRW3j.kV6IBWWNKJvp4O2sD/9cTQjrMdklGoUhifiYhXkT43VHm', utc_timestamp);        
...
values (3, 'b5741512-8fbc-47fa-9ac1-b530354fc0ff', 1, 7, 1, 1, '38400-222', 'Rua Natal', '200', null, 'Brasil','ENTREGUE', 
'2023-10-30 21:10:00', '2023-10-30 21:10:45', '2023-10-30 21:55:44', 110, 10, 120);
...
'ENTREGUE', '2023-11-02 20:34:04', '2023-11-02 20:35:10', '2023-11-02 21:10:32', 174.4, 5, 179.4);
...
'ENTREGUE', '2023-11-03 02:00:30', '2023-11-03 02:01:21', '2023-11-03 02:20:10', 87.2, 10, 97.2);
