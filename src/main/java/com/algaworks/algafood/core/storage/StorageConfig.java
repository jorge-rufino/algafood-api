...
//	Configuraçoes da API da AmazonS3
//	Este Bean só será criado caso esteja definido no "applicaton.properties"
	...
	public AmazonS3 amazonS3() {
		...
		var credentials = new BasicAWSCredentials(
				storageProperties.getS3().getIdChaveAcesso(), storageProperties.getS3().getIdChaveAcessoSecreta());
...
//	Define qual o storage será utilizado
	@Bean
