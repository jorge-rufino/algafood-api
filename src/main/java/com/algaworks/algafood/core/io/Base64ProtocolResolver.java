...
//Classe responsavel por pegar o valor da chave no application.properties
public class Base64ProtocolResolver implements ProtocolResolver, ApplicationListener<ApplicationContextInitializedEvent>{
	...
	public Resource resolve(String location, ResourceLoader resourceLoader) {
		if(location.startsWith("base64:")) {
			byte[] decodedResource = Base64.getDecoder().decode(location.substring(7));	//Pega a string a partir da 7 posicao para ignorar "base64:"
