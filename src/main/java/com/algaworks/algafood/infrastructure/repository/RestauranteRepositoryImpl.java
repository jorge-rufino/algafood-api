...
//	@Lazy server para evitar a "referencia circular", fazendo com que a dependencia entre as classes seja feita somente quando necessário
	@Autowired @Lazy
	...
	public List<Restaurante> find (String nome, BigDecimal taxaFreteInicial, BigDecimal taxaFreteFinal){
		...
		Root<Restaurante> root = criteria.from(Restaurante.class); // O "root" equivale ao "from Restaurante"
